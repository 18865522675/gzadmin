    ...
    <div class="schoolManagementWrap">
        <el-card class="pageCard">
            <div class="pageHead flexItem">
                ...
                <span class='label marL10'>文档</span>
                <div class="marL10">
                    <!--searchInp-->

                    <el-input v-model="tableForm.name" class='searchInp' placeholder="请输入辅导文档名称">
...
//      ]
        ...
        methods: {
            ...
            getDisciplineList(){
                this.$api.preGuide.getGuidePreDoc_discipliness({
                    pageNum:1,
                    pageSize:1000
                }).then((res)=>{
            ...
            getCourseList(){
                this.$api.preGuide.getGuidePreDoc_courses({
                    pageNum:1,
                    pageSize:1000
                }).then((res)=>{
            ...
            add_ajax() {
                if (this.dialogType === 0) {
                    ...
                    this.$api.preGuide
                        .preGuideDoc_edit(this.form.id,this.form)
                        .then(() => {
                            this.$message({
                                type: "success",
                                message: "编辑成功!"
