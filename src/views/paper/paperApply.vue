...
//          this.getStudentPreSimpleDisplines();
        ...
        methods: {
            ...
            getBatchList(){
                this.$api.paper.getPaperApply_simpleBatch().then((res)=>{
...
//                  this.get_ajax();
            ...
            getStudentPreSimpleMajors(){
                this.$api.paper.getPaperApply_simpleMajor().then((res)=>{
                    this.majorList=res.data
                })
            },
            getStudentPreSimpleStations(){
                this.$api.paper.getPaperApply_simpleStation().then((res)=>{
...
//      ableStatus: row.ableStatus //启用状态(1启用0禁用)
            ...
            submitApplyForm(){
            	 if (this.applyType) {
                    this.$api.paper
                        .applyPass(this.applyId,this.applyForm)
                        .then(() => {
                            this.$message({
                                type: "success",
                                message: "通过成功!"
                    ...
                    this.$api.paper
                        .applyRefuse(this.applyId,this.applyForm)
                        .then(() => {
                            this.$message({
                                type: "success",
                                message: "拒绝成功!"
