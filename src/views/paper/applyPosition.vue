        ...
        <el-card class="pageCard">
            ...
            <div class="pageCon">
                <el-table
                    ...
                    <el-table-column
                            prop="score"
                            label="论文成绩" :show-overflow-tooltip="true">
                    </el-table-column>
                    <el-table-column
                            prop="replyScore"
...
//          this.getStudentPreSimpleDisplines();
        ...
        methods: {
            ...
            getBatchList(){
                this.$api.paper.getPaperPosition_simpleBatch().then((res)=>{
...
//                  this.get_ajax();
            ...
            getTeacherList(){
                this.$api.paper.getPaperPosition_simpleTeacher().then((res)=>{
...
//                  this.get_ajax();
            ...
            getStudentPreSimpleMajors(){
                this.$api.paper.getPaperPosition_simpleMajor().then((res)=>{
                    this.majorList=res.data
                })
            },
            getStudentPreSimpleStations(){
                this.$api.paper.getPaperPosition_simpleStation().then((res)=>{
