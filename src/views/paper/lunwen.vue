        ...
        <el-card class="pageCard">
            ...
            <div class="pageCon">
                <el-table
                    ...
                    <el-table-column
                            prop="auditStatus"
                            label="审核" :show-overflow-tooltip="true" :formatter="formats">
                    </el-table-column>
                    <el-table-column
                            prop="score"
                            label="评分" :show-overflow-tooltip="true">
                    </el-table-column>
                    <!--<el-table-column
                            prop="commitTime"
...
//          this.getStudentPreSimpleDisplines();
        ...
        methods: {
            ...
            getBatchList(){
                this.$api.paper.getPaperLunwen_simpleBatch().then((res)=>{
...
//                  this.get_ajax();
            ...
            getTeacherList(){
                this.$api.paper.getPaperLunwen_simpleTeacher().then((res)=>{
...
//                  this.get_ajax();
            ...
            getStudentPreSimpleMajors(){
                this.$api.paper.getPaperLunwen_simpleMajor().then((res)=>{
                    this.majorList=res.data
                })
            },
            getStudentPreSimpleStations(){
                this.$api.paper.getPaperLunwen_simpleStation().then((res)=>{
