<template>
  <div class="g-module">
      ...
      <el-form ref="form" :rules="rulesForm" :model="form" label-width="120px" class="kf-form-add">
        <el-form-item label="科类" prop="name">
...
//      if (valid) {
          ...
          this.$api.essentialInformation.subjectManagement_edit(this.nowItem.id,{
...
//    });
    ...
    add_ajax() {
      if (this.dialogType === 0) {
        this.$api.essentialInformation
          .subjectManagement_add(this.form)
          .then(() => {
            this.$message({
              type: "success",
              message: "添加成功!"
