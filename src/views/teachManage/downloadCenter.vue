  			 ...
  			 <el-table
		        ...
		        <el-table-column
		          ...
		          <template slot-scope="scope">
		            ...
		            <baseDelBtn delUrl="teaching/doc" :delId="scope.row.id" :delOk="get_ajax" v-if="extra.indexOf('删除')>-1"/>
		          </template>
		        </el-table-column>
		      </el-table>
		        <el-pagination
  ...
  methods: {
    ...
    add_ajax() {
      if (this.dialogType === 0) {
        ...
        this.$api.teachManage
          .getDownload_edit(this.form.id,this.form)
          .then(() => {
            this.$message({
              type: "success",
              message: "编辑成功!"
