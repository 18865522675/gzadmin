        ...
        <el-card class="pageCard">
            <div class="pageHead flexItem" style="flex-wrap:wrap">
                ...
                <div class="headTopItem">
                    ...
                    <div class="marL10">
                        <el-select v-model="tableForm.selected" class="kf-select" placeholder="请选择考试类型" filterable  @change="searchChange">
                            <el-option label="所有" value=""/>
                            <el-option label="未安排" :value="0"/>
                            <el-option label="已安排" :value="1"/>
                            <el-option label="当前考场" :value="2"/>
                        </el-select>
                    </div>
                </div>
               ...
               <div class="headTopItem">
                ...
                <div  style="margin-top: 20px;" class="comTopReleteBtn  comTopOrangeBtn topBtn" @click="save">
                  	保存
                </div>
            </div>
...
//		            this.$message.info("取消申请")
            ...
            get_ajax() {
                ...
                this.$api.exam
                    .getRelateStudents(this.placeId,{
