...
//	this.getStationList();
        ...
        methods: {
            ...
            get_ajax() {
                ...
                if(this.type==2){
                    this.$api.exam
                        .get_courseExamExerciseList(this.$route.params.workId)
                        .then(res => {
                    ...
                    this.$api.exam.get_courseExamExerciseListAll({
                    	planId:this.planId,
                        exerciseType:""
                    }).then((res)=>{
...
//      ableStatus: row.ableStatus //启用状态(1启用0禁用)
            ...
            savePager(){
                ...
                this.$api.exam.examAddExercises({
                	taskId:this.$route.params.workId,
                	simpleCount,
                	multipleCount,
                	judgementCount,
