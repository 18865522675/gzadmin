        ...
        <el-card class="pageCard">
            <div class="pageHead flexItem" style="flex-wrap:wrap">
                ...
                <div class="headTopItem">
                    ...
                    <div class="marL10">
                        <el-select v-model="tableForm.examType" class="kf-select" placeholder="请选择层次" filterable  @change="searchChange">
                            <el-option label="所有" value=""/>
                ...
                <!--<div class="headTopItem">
                    <span class='label marL10'>考试类型</span>
                    <div class="marL10">
                        <el-select v-model="tableForm.finishStatus" class="kf-select" placeholder="请选择层次" filterable  @change="searchChange">
                            <el-option label="所有" value=""/>
               ...
               <div class="headTopItem">
				...
				<download url="/exam/online/score/export" text='数据导出' class="marL10 marT20"  />
